...
An HTML 19-slide workshop presentation built in the same style as the n8n Accra deck.
...
The deck currently stops after defining the product and mapping its OpenClaw configuration, including optional `TOOLS.md` and `HEARTBEAT.md` extensions: an executive assistant for Franky 5. Later build and testing slides are intentionally omitted until the setup is complete.
